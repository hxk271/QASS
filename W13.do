...
*multiple mediators: not_smsa -> collgrad, union -> ln_wage
	...
	*data prep
	...
	keep if !missing(not_smsa, collgrad, union, ln_wage)
	est clear
	
	*total effect
	eststo: reg ln_wage not_smsa
	scalar teff=_b[not_smsa]
	
	*direct effect and two indirect effects
	eststo: reg ln_wage not_smsa collgrad union
	...
	*the rest of two indirect effects
	eststo: reg collgrad not_smsa
	scalar ieff1_collgrad=_b[not_smsa]      //via collgrad
	eststo: reg union not_smsa
